...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid bg-3 text-center">
            <h1>¡Conoce nuestra variedad de productos!</h1>

            <div class="container-fluid text-center">
            <h3>Lo mejor de la casa</h3>
            <p>"No te limites en probar nuestros postres de alta linea, preparados con los mas finos ingredientes" <br>
            Cada producto hecho por Vanillanilla tiene impreso todo el amor y calidad que merece tu paladar.</p>
            <br>
        </div>
