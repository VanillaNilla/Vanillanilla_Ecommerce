...
if(isset($_GET["id"])){
            ...
            $r= mysqli_fetch_assoc($connection,$sql);
            $n = mysqli_num_rows($r);
            if($n!=1){
                ...
                header("location:index.php");
                    ...
                    $clave1 = $_GET["clave"];
                        ...
                        $sql = "UPDATE usuarios SET contrasena='".$clave1."'WHERE ID_usuario=".$id;
                        if(mysqli_query($connection,$sql)){
                            ...
                            $errores= "Error al actualizar la contrasena";
                        }
                ...
                <div class="col-sm-8 text-left">
					...
					if(isset($errores)){
						print '<div class="alert alert-danger">';
							print "<strong>* ".$errores."</strong>";
						print '</div>';
					}
				    ?>


                    <h1><strong>CONTRASENA ACTUALIZADA</strong> </h1>
                    <br>
