        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <h1><strong>¡Gracias por su compra!</strong> VanillaNilla se encargará de endulzar tu vida~ ♥.</h1>
                    <br>
                    ...
                    <div class="well" id="mapa">
                        ...
                        <br>
                        <h4>Te invitamos también a conocer nuestra tienda física~</h4>
