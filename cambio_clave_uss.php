        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <p>
                        <strong></strong><h1>CAMBIO DE CONTRASEÑA:</h1></strong>
                        
                        <form class="text-left" action="cambio_clave_uss.php" method="post">

                        <div class="form-group">
                            <label for="clave">* Nueva clave de acceso:</label>
                            <input type="password" name="clave" id="clave" class="form-control" required placeholder="Escribe tu nueva contraseña" value="">
                        </div>

                        <div class="form-group">
                            <label for="clave">* Confirmación de Clave de acceso:</label>
                            <input type="password" name="clave_nueva" id="clave_nueva" class="form-control" required placeholder="Escribe nuevamente tu nueva contraseña" value="">
                        </div>
