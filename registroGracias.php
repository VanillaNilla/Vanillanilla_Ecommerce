        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <br>
                    <h1><strong>¡Gracias por registrarte!</strong> Ahora podrás realizar compras con mayor comodidad~ ♥.</h1>
                    <br>
                    <p>Te invitamos a leer nuestro <a href="aviso.php">aviso de privacidad.</a> </p>
                    <br>
