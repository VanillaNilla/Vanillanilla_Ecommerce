                    ...
                    <?php } else { ?>
                        ...
                        <form class="text-left">
                            <div class="form-group">
                                ...
                                <input type="email" nombre="email" id="email" class="form-control" required placeholder="Escribe tu correo electrónico">
                            </div>

                            <div class="form-group">
                                <label for="clave">Clave de acceso:</label>
                                <input type="password" nombre="clave" id="clave" class="form-control" required placeholder="Escribe tu contraseña">
                            </div>
